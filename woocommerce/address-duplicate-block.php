<div class="address-block address-duplicate-block">
    ...
    if (!$formatted_address)
        _e( 'You have not set up a shipping address yet.', permaslug() );
    else
        echo '<address>'.$formatted_address.'</address>';

    ?>
    <div class="buttons">
        <button type="button" class="button selectable" data-index="<?php echo $idx; ?>"><?php _e('Ship to this address', permaslug()); ?></button>
