...
<p><?php _e('Select the addresses where you want to ship this order to.', permaslug()); ?></p>
...
?>
    ...
    <div>
        <input type="submit" class="button-primary button alt" name="duplicate_submit" value="<?php _e('Duplicate Cart', permaslug()); ?>" />
    </div>
