...
?>
    <div class="buttons">
        <a class="button" href="<?php echo $edit_link; ?>#shipping_address"><?php _e('Edit', permaslug()); ?></a>
        <a class="button ms_delete_address" data-idx="<?php echo $idx; ?>" href="#"><?php _e('Delete', permaslug()); ?></a>
    </div>
<?php
}
?>
